...
enum EJ_UNIFORM_FORMAT {
	...
	EJ_UNIFORM_MATRIX4,
	EJ_UNIFORM_INT1,
    EJ_UNIFORM_FLOAT3_ARRAY,
    EJ_UNIFORM_FLOAT4_ARRAY,
	EJ_UNIFORM_MATRIX4_ARRAY,
};
...
void render_draw_elements(struct render *R, enum EJ_DRAW_MODE mode, int fromidx, int ni, int type_short);
void render_draw_elements_vao(struct render *R, enum EJ_DRAW_MODE mode, int fromidx, int ni, unsigned int vao, int type_short);
