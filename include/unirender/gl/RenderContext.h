...
// 	virtual int  GetCurrRenderTarget() const;
	...
	virtual void StencilFunc(STENCIL_FUNC func, int ref, int mask);
	virtual void StencilOp(STENCIL_OP fail, STENCIL_OP zfail, STENCIL_OP zpass);
